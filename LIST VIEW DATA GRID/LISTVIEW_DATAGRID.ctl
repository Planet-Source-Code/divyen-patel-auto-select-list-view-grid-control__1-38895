...
With LIST_VIEW_GRID
            ...
            For I = 1 To RS.Fields.Count - 1
                    .ColumnHeaders.Add I, RS.Fields(I - 1).Name, RS.Fields(I - 1).Name
            Next
            
            While RS.EOF <> True
                        'ADD KEY RECORD , FIRST RECORD MUST BE THE KEY FIELD
                        .ListItems.Add 1, RS.Fields(0).Value, RS.Fields(0).Value
...
Public Function OPEN_RECORD(STR_QRY As String)
